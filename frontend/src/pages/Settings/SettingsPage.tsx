...
import ProcessTemplatesTab from './ProcessTemplates/ProcessTemplatesTab';
  ...
  return (
    <Tabs
      items={[
        ...
        { key: 'processTemplates', label: t('settingsProc.tab', 'Регламенты'), children: <ProcessTemplatesTab /> },
